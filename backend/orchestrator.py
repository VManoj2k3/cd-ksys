...
# markers that identify machine-generated files (AUTOSAR RTE, codegen, etc.)
_GENERATED_MARKERS = (
...
def _looks_generated(code: str) -> str:
    """Return a marker string if the file looks machine-generated, else ''."""
    head = code[:4000].lower()
